                ...
                if (player.puuid == puu_id) {
                  ...
                  $("#history_each_wrap").append(
                    '<div class="history_cont_wrap"><div class="history_rank" ' +
                      ...
                      '>#<span class="hst_rank">' +
                      player.placement +
                      '</span></div><div class="history_cont"><div class="summary"><span class="p_time">플레이타임</span><span class="p_day">플레이날짜</span></div><div class="history_flex_box"><div class="traits">특성</div><div class="augments">증강</div></div><div class="units">유닛</div></div></div>'
                  );
                }
              });
            });
